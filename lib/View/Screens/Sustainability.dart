...
class _SustainabilityState extends State<Sustainability> {
          ...
          children: [
            Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  overAllStatus(title: 'Sustainability Overall status', data: sustainability),
  ...
  //   List<PieChartSectionData> data = pieChartDataFor(sustainability);
  //   return Card(
  //     elevation: 2.h,
  //     color: Colors.white,
  ...
  //                 children: [
  //                   Text('Sustainability Overall status', style: TextStyle(color: greyColor, fontSize: 12.sp, fontWeight: FontWeight.bold)),
          ...
          children: [
            ...
            Expanded(
              child: Container(
                  ...
                  child: Row(
                    children: [
                      subStrategyCharts(title: "Environmental Stewardship", data: sortedBySubStrategy(sustainability, 'environmental stewardship')),
                      subStrategyCharts(title: "Production & Integrity", data: sortedBySubStrategy(sustainability, 'production & integrity')),
                    ],
                  )),
            )
          ],
