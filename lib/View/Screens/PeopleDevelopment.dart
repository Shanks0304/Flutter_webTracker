...
class PeopleDevelopment extends StatefulWidget {
  const PeopleDevelopment({Key? key}) : super(key: key);

  @override
  _PeopleDevelopmentState createState() => _PeopleDevelopmentState();
}

class _PeopleDevelopmentState extends State<PeopleDevelopment> {
  @override
          ...
          children: [
            Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  overAllStatus(title: 'People Development & Engagement Status', data: peopleDevelopment),
  ...
  //   List<PieChartSectionData> data = pieChartDataFor(peopleDevelopment);
  //   return Card(
  //     elevation: 2.h,
  //     color: Colors.white,
  ...
  //                 children: [
  //                   Text('People Development & Engagement Status', style: TextStyle(color: greyColor, fontSize: 12.sp, fontWeight: FontWeight.bold)),
          ...
          children: [
            ...
            Expanded(
              child: Container(
                  ...
                  child: Row(
                    children: [
                      subStrategyCharts(title: "Employee Wellbeing", data: sortedBySubStrategy(peopleDevelopment, 'employee wellbeing')),
                      subStrategyCharts(title: "T&D Administration & Oversight", data: sortedBySubStrategy(peopleDevelopment, 't&d administration & talents oversight')),
                      subStrategyCharts(title: "Employ Performance & Engagement", data: sortedBySubStrategy(peopleDevelopment, 'employee performance & engagement')),
                    ],
                  )),
            )
          ],
